...
ggplot(diamonds) + goem_point(mapping = aes(x = carat, y = price, color = clarity))

# Draw another scatter plot for `diamonds_sample` of price (y) by carat (x),
# but with all of the dots colored "blue".
# Hint: you'll need to set the color channel, not map a value to it!
ggplot(diamonds) + goem_point(mapping = aes(x = carat, y = price, color = "blue"))
...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = price, size = price , color = price))
...
ggplot(data = diamonds_sample) + geom_smooth(mapping = aes(x = cut, y = price, cut = clarity))
